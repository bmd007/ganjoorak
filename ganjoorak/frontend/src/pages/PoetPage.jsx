  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Link
          to={`/admin?poetId=${poet.id}`}
          className="px-4 py-2 rounded-xl bg-primary-600 text-white text-sm font-medium hover:bg-primary-700 transition-colors flex items-center gap-1.5"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
